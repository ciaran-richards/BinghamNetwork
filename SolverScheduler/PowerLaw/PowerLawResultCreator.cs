...
namespace SolverScheduler
{
    class PowerLawResultCreator
    {
        ...
        public IsoResultStruct EvaluateAngle(Network[] Networks, double pGrad, double pAngle, double index)
        {
